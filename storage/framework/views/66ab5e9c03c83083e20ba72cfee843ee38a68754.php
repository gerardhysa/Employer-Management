    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8 col-md-offset-2 ">
                ...
                <form enctype="multipart/form-data" action="/profileEditPhoto/<?php echo e($user->id); ?>" method="POST">
            ...
            <div class="col-md-8 col-md-offset-2 ">
                ...
                <form action="/profileEdit/<?php echo e($user->id); ?>" method="POST">
                    ...
                    <input type="text" name="department" class="form-control input-lg" value="<?php echo e($user->department); ?>">
